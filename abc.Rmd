...
#skuska3 <- long_panel(skuska2, id = "ac")
#skuska3<- skuska2 %>%  pivot_longer(everything())
#skuska3 <- skuska2 %>% melt(id.var= "ac") %>% arrange(ac)
#skuska3<- skuska2 %>% reshape(f
 #       varying = c(4:27),
  #      direction = "long"
#)
...
#sdate <- 'December.12.2015'
#as.Date(sdate, format = "%B.%d.%Y")
...
#final$variable<- str_remove(final$variable, " /**")
